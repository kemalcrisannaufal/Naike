const ProductTableSkeleton = () => {
  ...
  const tableCellClass = "px-4 py-2 text-center bg-neutral-100 animate-pulse";
        ...
        <tbody>
          {Array.from({ length: 6 }).map((_, index) => (
            <tr className="border-neutral-300" key={index}>
              ...
              <td className={tableCellClass}>
                <div className="bg-neutral-200 mx-auto rounded w-20 h-4 animate-pulse" />
              </td>
              <td className={tableCellClass}>
                <div className="bg-neutral-200 mx-auto rounded w-16 h-4 animate-pulse" />
              </td>
              <td className={tableCellClass}>
                <div className="bg-neutral-200 mx-auto rounded w-12 h-4 animate-pulse" />
              </td>
              <td className={tableCellClass}>
                <div className="bg-neutral-200 mx-auto rounded w-12 h-4 animate-pulse" />
              </td>
